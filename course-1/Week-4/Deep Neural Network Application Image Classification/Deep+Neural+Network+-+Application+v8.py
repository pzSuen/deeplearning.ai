...
# The way this works is slightly different than dreload. Some caveats apply,
# type %autoreload? to see what can go wrong.
...
def two_layer_model(X, Y, layers_dims, learning_rate = 0.0075,
    ...
    # by calling one of the functions you'd previously implemented
    ...
    for i in range(0, num_iterations):
        ...
        # Retrieve W1, b1, W2, b2 from parameters   重新检索到W1,b1,W2,b2
        W1 = parameters["W1"]
        b1 = parameters["b1"]
        W2 = parameters["W2"]
        b2 = parameters["b2"]
...
def L_layer_model(X, Y, layers_dims, learning_rate = 0.0075, num_iterations = 3000, print_cost=False):
    ...
    for i in range(0, num_iterations):
        ...
        # Backward propagation.
        ### START CODE HERE ### (≈ 1 line of code)
        grads = L_model_backward(AL,Y,caches)           # Y是用来计算dAL
        ### END CODE HERE ###
